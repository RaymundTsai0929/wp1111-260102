...
*   **網頁架構**：理解 Client-Server Request-Response 模型，並將網頁部署於 GitHub Pages 提供靜態資源服務，讓全球使用者皆可透過 URL 訪問。
...
*   **學習體會**：
    *   透過 W3Schools 的系統化學習，我深入理解了 CSS 的層疊 (Cascading) 與權重邏輯，學會如何更有效率地管理全域 (Globals) 與局部樣式。
